  ...
  <div class="bg-slate-blue/10 py-[14px] rounded-md dark:bg-black-russian w-full block">
    <div class="flex items-center justify-center w-full gap-2">
      ...
      >
        ...
        />
        <div
          class="w-[14px] h-[14px] rounded-full bg-white transition peer-checked:translate-x-5"
        />
      </label>

      <div>
        <svg class="fill-ship-cove" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
          <path
